...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kou-21.51-kourovka-notebook-problem-21.51-106af066-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KOU-21.51"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kou-21.51-kourovka-notebook-problem-21.51-106af066-v1",
      "problem_contract_sha256": "ffe7f37a5861393315c1605f0922c6b1b7f9c0210dfc1d577c5c5fc371977a16",
      "problem_id": "problem:um-kou-21.51-kourovka-notebook-problem-21.51-106af066",
      "route_id": "route:um-kou-21.51-kourovka-notebook-problem-21.51-106af066-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kou-21.51-kourovka-notebook-problem-21.51-106af066-source-fidelity-01",
      "graph_id": "graph:um-kou-21.51-kourovka-notebook-problem-21.51-106af066-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kou-21.51-kourovka-notebook-problem-21.51-106af066-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kou-21.51-kourovka-notebook-problem-21.51-106af066-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $p$ be a prime, and $P$ a finite $p$-group. (a) Suppose that $P$ has an abelian subgroup of order $p^n$. For which $n$ does $P$ necessarily have a normal abelian subgroup of order $p^n$? (b) Suppose that $P$ has an elementary abelian subgroup of order $p^n$. For which $n$ does $P$ necessarily have a normal elementary abelian subgroup of order $p^n$?"
          },
          "statement_sha256": "de3c8079849c3a9fe6ebbc66b87cb34da3cc42e597bc9d64a944352f1b80f5b1"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kou-21.51-kourovka-notebook-problem-21.51-106af066-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kou-21.51-kourovka-notebook-problem-21.51-106af066-root",
      "route_id": "route:um-kou-21.51-kourovka-notebook-problem-21.51-106af066-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kou-21.51-2c03fa90703c",
        "url": "https://www.unsolvedmath.com/problems/KOU-21.51"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
